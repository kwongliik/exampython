...
<br>Question 1: You need to do 5 corrections on the code in order to give correct output as follows:
...
<br>
<br>Question 2: You need to complete the code for calculating the volume of cone and give output as follows:
