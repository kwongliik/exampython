...
from question_5_compound_interest import compound_interest, calculate_and_print_interest
...
def test_calculate_and_print_interest(monkeypatch, capsys):
    ...
    assert captured.out.strip() == "Compound interest is 13079.91"